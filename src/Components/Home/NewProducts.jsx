...
import { faStar,faHeart,faArrowUpRightFromSquare } from '@fortawesome/free-solid-svg-icons';
         ...
         <div className="product-sec-slider">
            <div className="info-tag">
               <ul className="info-tag-list">
                  ...
                  <li><a><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></a></li>
               </ul>
            </div>
           <figure><img src={ProductImg1}/></figure> 
            <figcaption>
