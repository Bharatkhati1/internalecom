   ...
   <div className='container'>
      <div className='row'>
         <div className='col-md-3 about-us-footer'>
            ...
            <p>Proin a interdum elit. Etiam eu sapien sem. Suspendisse a massa justo. Cras eget lorem nunc. Fusce nec urna tempus tempus
            </p>
            <div className="social-icon">
               <a href="#"><img src={FacebookIcon}/></a>
               <a href="#"><img src={TweeterIcon}/></a>
         ...
         <div className="col-md-2 footer-coloum ms-auto">
            ...
            <ul className="footer-links">
               <li><a>Mobiles &amp; Tablets</a></li>
               <li><a>Laptops &amp; Computers</a></li>
               <li><a>Audio and Video</a></li>
         ...
         <div className="col-md-3 footer-coloum ms-auto">
            ...
            <ul className="footer-links">
               ...
               <li><a href='/TermsCondition'>Privacy Policy</a></li>
         ...
         <div className="col-md-3 footer-coloum">
            <h3>Contact</h3>
            <h2 className="footer-inner-title mb-1">NEWSLETTER
            </h2>
