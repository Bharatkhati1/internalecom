...
import { sendNotification } from "../../Services/emailApiServices";
import { notificationTemplates } from "../Common/notificationTemplates";
              ...
              {blogsData.map((blog) => (
                <div key={blog.id}>
                  <div className="latest-blog-content">
                    <figure>
                      {" "}
                      <img src={blogImg2} alt={blog.title}></img>
                    </figure>
                    <figcaption>
                      <h3>{blog.title}</h3>
                      <span>
